...
const owners = [
    {
        "id": "851173331976585278",
        "post": "Developer",
        "GHURL": "https://github.com/Hanafudas",
        "InstaURL": "",
        "YTURL": ""
    }
]
...
for (let indexOne = 0; indexOne < Staff.length; indexOne++) {
    const elementOwners = Staff[indexOne];
    ...
    $.getJSON(API + elementOwners.id)
        .then(output => {
            ...
            const StaffList = "<div id='trigger' class='card' style='margin: 15px;'><div class='banner'><img src='" + output.url + "'></div></br></br></br></br><h2 class='name'>" + output.username + "</h2><div class='title'><h1 id='trigger2' style='font-size: 26px; color: #000000;'>" + elementOwners.post + "</h2></div><div class='actions'><div class='follow-btn' style='margin-bottom: 5px;'><a href='" + elementOwners.InstaURL + "' target='_blank'><button style='color: #000000;'>Instagram</button></a></div><div class='follow-btn'><a href='"
            boxOwners.innerHTML += StaffList;
        });
}